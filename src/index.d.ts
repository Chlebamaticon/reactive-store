...
interface Select<S = any, P = any> {
    (fragment: S, props?: P): any
}

type Selector<S = any, P = any> = Select<S, P> | false;
...
export function withStore<P = any, A extends StateProduct = StateProduct>(states: [A], stateSelector?: Selector<ExtractState<A>, P>, actionsSelector?: Selector<ExtractActions<A>>): WithStoreDecorator;
export function withStore<P = any, A extends StateProduct = StateProduct, B extends StateProduct = StateProduct>(states: [A, B], stateSelector?: Selector<ExtractState<A> & ExtractState<B>, P> , actionsSelector?: Selector<ExtractActions<A> & ExtractActions<B>>): WithStoreDecorator;
export function withStore<P = any, A extends StateProduct = StateProduct, B extends StateProduct = StateProduct, C extends StateProduct = StateProduct>(states: [A, B, C], stateSelector?: Selector<ExtractState<A> & ExtractActions<B> & ExtractActions<C>, P>, actionsSelector?: Selector<ExtractActions<A> & ExtractActions<B> & ExtractActions<C>>): WithStoreDecorator;
export function withStore<P = any, A extends StateProduct = StateProduct, B extends StateProduct = StateProduct, C extends StateProduct = StateProduct, D extends StateProduct = StateProduct>(states: [A, B, C, D], stateSelector?: Selector<ExtractState<A> & ExtractState<B> & ExtractState<C> & ExtractState<D>, P>, actionsSelector?: Selector<ExtractActions<A> & ExtractActions<B> & ExtractActions<C> & ExtractActions<D>>): WithStoreDecorator;
export function withStore<P = any, A extends StateProduct = StateProduct, B extends StateProduct = StateProduct, C extends StateProduct = StateProduct, D extends StateProduct = StateProduct, E extends StateProduct = StateProduct>(states: [A, B, C, D, E], stateSelector?: Selector<ExtractState<A> & ExtractState<B> & ExtractState<C> & ExtractState<D> & ExtractState<E>, P>, actionsSelector?: Selector<ExtractActions<A> & ExtractActions<B> & ExtractActions<C> & ExtractActions<D> & ExtractActions<E>>): WithStoreDecorator;
export function withStore<P = any, A extends StateProduct = StateProduct, B extends StateProduct = StateProduct, C extends StateProduct = StateProduct, D extends StateProduct = StateProduct, E extends StateProduct = StateProduct, F extends StateProduct = StateProduct>(states: [A, B, C, D, E, F], stateSelector?: Selector<ExtractState<A> & ExtractState<B> & ExtractState<C> & ExtractState<D> & ExtractState<E> & ExtractState<F>, P>, actionsSelector?: Selector<ExtractActions<A> & ExtractActions<B> & ExtractActions<C> & ExtractActions<D> & ExtractActions<E> & ExtractActions<F>>): WithStoreDecorator;
export function withStore<P = any, A extends StateProduct = StateProduct, B extends StateProduct = StateProduct, C extends StateProduct = StateProduct, D extends StateProduct = StateProduct, E extends StateProduct = StateProduct, F extends StateProduct = StateProduct, G extends StateProduct = StateProduct>(states: [A, B, C, D, E, F, G], stateSelector?: Selector<ExtractState<A> & ExtractState<B> & ExtractState<C> & ExtractState<D> & ExtractState<E> & ExtractState<F> & ExtractState<G>, P>, actionsSelector?: Selector<ExtractActions<A> & ExtractActions<B> & ExtractActions<C> & ExtractActions<D> & ExtractActions<E> & ExtractActions<F> & ExtractActions<G>>): WithStoreDecorator;
export function withStore<P = any, A extends StateProduct = StateProduct, B extends StateProduct = StateProduct, C extends StateProduct = StateProduct, D extends StateProduct = StateProduct, E extends StateProduct = StateProduct, F extends StateProduct = StateProduct, G extends StateProduct = StateProduct, H extends StateProduct = StateProduct>(states: [A, B, C, D, E, F, G, H], stateSelector?: Selector<ExtractState<A> & ExtractState<B> & ExtractState<C> & ExtractState<D> & ExtractState<E> & ExtractState<F> & ExtractState<G> & ExtractState<H>, P>, actionsSelector?: Selector<ExtractActions<A> & ExtractActions<B> & ExtractActions<C> & ExtractActions<D> & ExtractActions<E> & ExtractActions<F> & ExtractActions<G> & ExtractActions<H>>): WithStoreDecorator;
export function withStore<P = any, A extends StateProduct = StateProduct, B extends StateProduct = StateProduct, C extends StateProduct = StateProduct, D extends StateProduct = StateProduct, E extends StateProduct = StateProduct, F extends StateProduct = StateProduct, G extends StateProduct = StateProduct, H extends StateProduct = StateProduct, I extends StateProduct = StateProduct>(states: [A, B, C, D, E, F, G, H, I], stateSelector?: Selector<ExtractState<A> & ExtractState<B> & ExtractState<C> & ExtractState<D> & ExtractState<E> & ExtractState<F> & ExtractState<G> & ExtractState<H> & ExtractState<I>, P>, actionsSelector?: Selector<ExtractActions<A> & ExtractActions<B> & ExtractActions<C> & ExtractActions<D> & ExtractActions<E> & ExtractActions<F> & ExtractActions<G> & ExtractActions<H> & ExtractActions<I>>): WithStoreDecorator;
export function withStore<P = any, A extends StateProduct = StateProduct, B extends StateProduct = StateProduct, C extends StateProduct = StateProduct, D extends StateProduct = StateProduct, E extends StateProduct = StateProduct, F extends StateProduct = StateProduct, G extends StateProduct = StateProduct, H extends StateProduct = StateProduct, I extends StateProduct = StateProduct, J extends StateProduct>(states: [A, B, C, D, E, F, G, H, I, J], stateSelector?: Selector<ExtractState<A> & ExtractState<B> & ExtractState<C> & ExtractState<D> & ExtractState<E> & ExtractState<F> & ExtractState<G> & ExtractState<H> & ExtractState<I> & ExtractState<J>, P>, actionsSelector?: Selector<ExtractActions<A> & ExtractActions<B> & ExtractActions<C> & ExtractActions<D> & ExtractActions<E> & ExtractActions<F> & ExtractActions<G> & ExtractActions<H> & ExtractActions<I> & ExtractActions<J>>): WithStoreDecorator;
